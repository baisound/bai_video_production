...
| TASK-036 | Unified Desktop Editing Shell / Minimum Editing Workflow Integration | W0_W1_PARTIAL_PARKED_TO_H2_W2_PACKAGED_NATIVE_E2E_PASS | OWNER_DIRECTED_IMPLEMENTATION | DEV-4 | Trusted packaged launcher completed real Windows ingest/local ASR/subtitle/review/Resolve apply/native Render QA/atomic EDITOR_WORK with final UI `NONE`; clean-profile/runtime recovery/full DPI/accessibility/long-path remainder is parked to H2 without a PASS claim; post-W2 restart and final Context Cost remain |
