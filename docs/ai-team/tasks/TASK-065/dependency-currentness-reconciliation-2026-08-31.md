...
| --- | --- | --- | --- |
| D-068 / TASK-068 | corrected design is `IMMUTABLE_ONLY_V1`; canonical main still has no TASK-068 source/test and implementation receipt is N.C. The safe primitive scope is strict/pinned read, secure lock, immutable no-replace publish and durability only | completion receipt separately proves `PINNED_READ_PASS`, `LOCK_PASS`, `IMMUTABLE_NOREPLACE_PASS`, `DURABILITY_PASS` and fixes `MUTABLE_CAS_UNAVAILABLE / EXACT_DELETE_UNAVAILABLE / CURRENT_HEAD_AUTHORITY_NOT_CREATED`, `authority_created:false`, `currentness_selected:false`. Each consumer must supply its own trusted exact generation/head plan and tombstone semantics; no TASK-068 unit PASS promotes a consumer | `IMMUTABLE_ONLY_V1 / IMPLEMENTATION.N.C. / PL_B_SOURCE_START0 / EFFECT0` |
| D-069 / TASK-069 | negative/currentness matrix is prepared; source has not started and waits for TASK-068 completion. Current `origin/main=35cdf1a` logical tests are historical regression inputs, not Production readiness. Current pending loader rediscovers a physically retained pending record and cleanup requires path unlink, so replacing deletion with an unbound tombstone would repeat recovery on restart | after TASK-068, implement FB-R/C/P/PR/DUR, PRIV and READY plus consumer-owned exact plan-bound pending terminal tombstone semantics. Tombstone binds pending identity/source digest/public receipt/correlation/canonical commit/predecessor; resolver precedence is exact terminal correlation/tombstone > pending > fresh without scan-highest. Physical pending retention is non-authority and restart N produces canonical revision exactly one, recovery0, delete0. FB-X becomes no automatic delete, not an exact-delete claim | `CURRENT_HEAD_AUTHORITY_NOT_CREATED / PENDING_TOMBSTONE_RESOLVER.N.C. / START0 / TASK058_PRODUCTION_BASELINE.N.C. / EFFECT0` |
...
| D2.5 / TASK-067 | `PRESERVED_DIRTY / COMMIT_STOP`: at fresh `origin/main=35cdf1a`, canonical `docs/ai-team/tasks/TASK-067/`, TASK-067 remote branch and TASK-067 PR are all absent. The exact three-file candidate remains preserved, uncommitted and non-authoritative. Correlation outcome layering is narrow PASS, but the Bridge-required constructor/get path is create-capable and journal-absent A2 recovery is absent | canonical Task identity/owner/Allowed Files/dependency/C-H acceptance formalization; TASK-068/TASK-069, TASK-060/063 and corrected TASK-061-A PREACTIVATION PREPARE receipts; exact TASK-058 owner-preserving amendment; `T67-READBACK-NOCREATE` and `T67-A2-JOURNAL-ABSENT-TYPED-DUPLICATE` closure; fresh overlap/work-lock PASS; explicit implementation start, DEV-4 review and completion receipt | `CANONICAL_AUTHORITY.N.C. / T67-OUTCOME-LAYERING-CORRELATION PASS / T67-READBACK-NOCREATE P0.N.C. / T67-A2-JOURNAL-ABSENT-TYPED-DUPLICATE P0.N.C. / COMMIT_STOP / EFFECT0` |
...
2. `FB-C`: exact plan-bound immutable journal generations, predecessor and
   terminal-tombstone recovery identity; same-path CAS zero;
...
| --- | --- | --- |
| TASK-068 foundation | `IMMUTABLE_ONLY_V1`: pinned read, secure lock, immutable no-replace and durability PASS; mutable CAS/delete/current-head authority explicitly unavailable | implementation N.C. / receipt0 |
...
| TASK-065 design | Option B plus PLA-I01-I18, PL65-A06/A07, PLB-I01-I19, PLC-I01-I16, PL65-B00/B03/B04/B05/C01a/C01b and PL-D D01-D12; immutable generations are selected only by a trusted exact plan/receipt, with mutable pointer/scan-highest/auto-cleanup zero | task-local design active / PL-A/B/C/D START0 / source START0 |
