...
| TASK-023 | FasterWhisper Fast Local Provider | RECONCILIATION_IMPLEMENTED_VALIDATION_PENDING | OWNER_DIRECTED_IMPLEMENTATION | DEV-3 | Existing TASK-006 provider is canonical; 0.19.0 adds deterministic identity + diagnostic evidence CLI; PRODUCT-ARCH-001 target Subtitle Workspace is INTEGRATION_DESIGNED; no duplicate provider or ASR semantic change |
