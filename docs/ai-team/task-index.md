...
| TASK-036 | Unified Desktop Editing Shell / Minimum Editing Workflow Integration | FOUNDATION_IMPLEMENTED_W0_W1_PARTIAL_W2_DOWNSTREAM_BOUND_FULL_E2E_PENDING | OWNER_DIRECTED_IMPLEMENTATION | DEV-4 | Native WebView2 window/layout/dialog/focus and packaged one-dir EXE partially accepted; trusted downstream Application Service binding is implemented and regression-clean, while upstream Project/Media/Transcribe/Subtitle/Cut composition, real render-to-QA binding, clean-profile/runtime recovery/full DPI/accessibility and packaged conversation-free full E2E remain |
