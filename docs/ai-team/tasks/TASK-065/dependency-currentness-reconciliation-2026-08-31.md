...
| D3 / TASK-065 | `TASK_LOCAL_DESIGN_ACTIVE / SOURCE_START0`: PL-A PLA-I01-I18, PL-B PLB-I01-I17, C/D PLC-I01-I16, PL65-B00/C01a/C01b and PL-D D01-D11 are source-mapped. Public discovery/hash, build-input payload digest, path-bearing acceptance JSON, descriptor timestamps and descriptor-absent owner-only state are not current Product proof; packaged `discover` writes readback; no active-install selector exists | all upstream receipts; trusted zero/one/multiple registration; corrected noncreating reader; same-open descriptor/owner and installed payload manifest/tree; Product EXE/payload; journal-bound orphan recovery and operation-owned cleanup identity; trusted clock/session and predecessor/successor registration+payload revision propagated through PL-B CAS, TASK-036, PL-C, TASK-061-B and PL-D; accepted implementation Gate and separate Activation Gate. Root scan/timestamp/orphan winner prohibited | `PL_A_START0 / PL_B_START0 / PL_C_START0 / PL_D_START0 / SOURCE_START0 / EFFECT0` |
...
| TASK-065 design | Option B plus PLA-I01-I18, PLB-I01-I17, PLC-I01-I16, PL65-B00/C01a/C01b and PL-D D01-D11; one current-installation identity is preserved end-to-end, build-input/acceptance/timestamp/owner-only substitution is rejected and packaged `discover` is excluded | task-local design active / PL-A/B/C/D START0 / source START0 |
