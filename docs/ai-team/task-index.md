...
| TASK-002 | Resolve Capability Spike | IMPLEMENTED_AWAITING_FINAL_LIVE_EVIDENCE | AUTHORIZED_FOR_IMPLEMENTATION | DEV-4 / score 22 | Attempt 02 read-only Resolve accepted; sandbox behavior + WSL2 IPC + final ADR remain |
...
`docs/roadmap/PROJECT-ROADMAP-CANONICAL.md` is the current Project-level roadmap. It is a planning authority, not Owner Authorization for later TASKs.
