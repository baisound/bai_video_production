...
| TASK-030 | OSS Public Repository Readiness | IMPLEMENTED_AWAITING_GITHUB_CI | OWNER_DIRECTED_IMPLEMENTATION | DEV-2 | 0.6.4 OSS baseline; 0.6.5 canonical URL corrective; 0.6.6 provisions FFmpeg/ffprobe across the six-job CI matrix |
