...
| TASK-004 | Media Normalization + Local Visual/Audio AI Runtime Foundation | CAPABILITY_VERIFIED_AWAITING_LIVE_BEHAVIORAL_EVIDENCE | OWNER_AUTHORIZED_IMPLEMENTATION | DEV-4 / score 25 | Package 0.4.5; 243 tests; ComfyUI + Audacity/OpenVINO capability PASS; Noise Suppression + 2-stem behavioral Evidence pending; 4-stem fails closed on verified runtime because mode is UI-only |
