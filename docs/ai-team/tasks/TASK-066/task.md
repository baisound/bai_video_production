...
| GF-E | accepted GF-A manifest; active TASK-063 main-installer work must be terminal and read back | new TASK-066 packaging manifest/validator/tests; `task063_main_installer.iss` and existing EXE specs only after TASK-063 handoff and exact lock | TASK-063 bridge semantics, Product backends, display driver, system CUDA/PATH | Production Linkage Setup is sole packaging writer; TASK-063 handoff required |
