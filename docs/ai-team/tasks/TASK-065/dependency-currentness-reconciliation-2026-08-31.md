...
| --- | --- | --- | --- |
| D-068 / TASK-068 | no canonical task-local record, task-index/current-state/roadmap row, active lock or completion receipt exists at the audit base | canonical allocation and scope, exact Allowed Files, implementation/review plus the completion receipt required by TASK-069 and TASK-063 | `SOURCE.N.C. / EFFECT0` |
