...
| D2 / TASK-061 | disabled CA-A/B/C candidate exists; public migration readback is reconstructible, CA-A/CA-B confirmations are deterministic, CA-C apply accepts caller `now`, and CA-A/CA-C readers use permissive JSON | separate trusted one-shot CA-A/CA-B action tickets; private pinned CA-A terminal capability; trusted Product/OS clock and Product-authored history time; strict bounded authority parser/snapshot for CA-A/CA-B/CA-C; trusted native-backend-fixed apply capability; identity-safe writers and focused Windows/authority/parser/clock evidence | `DISABLED_CANDIDATE_PRESENT / EXECUTE_TICKET_CLOCK_JSON_AND_READBACK_AUTHORITY.N.C. / EFFECT0` |
