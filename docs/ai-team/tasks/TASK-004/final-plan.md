...
6. Add Local Video Generation service/CLI using MiniMax H3 as the first intended provider profile.
...
8. Add package schemas and unit/boundary/integration/fault/idempotency tests across all lanes, including commercial-runtime license gating before ComfyUI queue submission.
