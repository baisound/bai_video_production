...
| OR-18 | OBS plugin and meeting/live capture | TASK-047 `NEW` |
...
| OR-25 | OBS E-drive install baseline | TASK-047 exact capability probe `NEW` |
...
| Q19 | use exact target-machine probe baseline | TASK-046/047/035/020 |
...
| Q25 | evaluate Stable Audio for SFX/ambience | TASK-013/026/028 `EXTEND` |
