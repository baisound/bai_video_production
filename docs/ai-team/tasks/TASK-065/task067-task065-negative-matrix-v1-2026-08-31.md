...
| PL65-A01 | PL-A dependency admission and durable baseline reader | PL65-A00/TASK-069 durable receipt plus TASK-060/061/063/067, TASK-036 and SKILL-D2S-001 receipts are presented | public readiness/status/code presence, old hash, caller boolean, `safe_export:true`, isolated/synthetic fixture, wrong installed build or stale/cross-instance receipt | `BASELINE_N.C. / EFFECT0` until PL65-A00, installed exact sync and every dependency receipt passes pinned currentness | 0 | 0 | 0 | 0 | private paths/body 0 | one bound PL-A admission receipt names exact TASK-069 baseline, canonical/installed hashes and durable dependency receipt identities; all public readiness inputs authority_created=false |
