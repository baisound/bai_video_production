...
| TASK-036 | Unified Desktop Editing Shell / Minimum Editing Workflow Integration | MINIMUM_EDITING_PRODUCT_MVP_PASS_RELEASE_0_20_1_CANDIDATE | OWNER_DIRECTED_IMPLEMENTATION | DEV-4 | W0 clean-profile/runtime/path and W1 display/accessibility closure PASS; W2 packaged native route and v0.20.0 integration remain accepted; exact 0.20.1 patch release finalization is next |
